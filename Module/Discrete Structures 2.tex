...
output of the AND operation is $1$ only if all inputs are $1$.
...
the OR operation is $1$ if at least one input is $1$.
...
operation on it. We can write this as $x'$. The output of this operation
...
\section{Boolean Variables and Expressions}
